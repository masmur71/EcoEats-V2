...
class LoginPenjualScreen extends StatefulWidget {
  @override
  _LoginPenjualScreenState createState() => _LoginPenjualScreenState();
}

class _LoginPenjualScreenState extends State<LoginPenjualScreen> {
